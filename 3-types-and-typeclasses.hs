...
colourOrder = [minBound ::Colour .. maxBound ::Colour]
colourNumber colour = head [i | (i, c) <- zip [1..] colourOrder, c == colour]
paintMix c1 c2 = colourOrder !! (ceiling (((colourNumber c1 + colourNumber c2) / 2)) - 1)
